        ...
        <div className='flex items-center justify-between max-w-6xl p-3 mx-auto'>
            <Link to='/'>
                <h1 className='flex-wrap text-sm font-bold sm:text-xl'>
                    <span className='text-slate-500'>Milion</span>
            ...
            <ul className='flex gap-4'>
                ...
                <Link to='/profile'>   {currentUser ? ( <img className='object-cover rounded-full h-7 w-7' src={currentUser.avatar} /> ) : (  <li className=' text-slate-700 hover:underline'>Sign in</li>    ) }    </Link>
            </ul>
        </div>
    </header>
  )
